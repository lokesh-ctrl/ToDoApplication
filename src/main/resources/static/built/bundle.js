...
/***/ "./src/main/resources/static/js/InputTaker.js":
/*!****************************************************!*\
  !*** ./src/main/resources/static/js/InputTaker.js ***!
  \****************************************************/
/*! exports provided: InputTaker */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "InputTaker", function() { return InputTaker; });
...
function (_React$Component) {
  _inherits(InputTaker, _React$Component);

  function InputTaker(props) {
    var _this;

    _classCallCheck(this, InputTaker);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(InputTaker).call(this, props));
    _this.state = {
      value: ''
    };
  ...
  _createClass(InputTaker, [{
    ...
    key: "keyPress",
    value: function keyPress(pressedKey) {
      if (pressedKey.keyCode == 13) {//add task to the database
      }
    }
  }, {
    key: "render",
...
/***/ "./src/main/resources/static/js/ToDoItem.js":
/*!**************************************************!*\
  !*** ./src/main/resources/static/js/ToDoItem.js ***!
  \**************************************************/
...
function (_React$Component) {
  ...
  function ToDoItem(props) {
    ...
    _this.updateStatusOfTask = _this.updateStatusOfTask.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.renderTask = _this.renderTask.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    return _this;
  }

  _createClass(ToDoItem, [{
    key: "componentAboutToMount",
    value: function componentAboutToMount() {}
  }, {
    key: "renderTask",
    value: function renderTask() {
      return React.createElement("div", {
        ...
        id: "checkBoxOfTask",
        onClick: this.updateStatusOfTask,
        type: "checkbox",
        checked: this.props.task.isFinished
      }), React.createElement("label", {
        id: "taskName"
      }, this.props.task.taskName), React.createElement("button", {
        id: "deleteTask",
    ...
    key: "updateStatusOfTask",
    value: function updateStatusOfTask() {//update status of task in db
    }
  }, {
    key: "render",
    value: function render() {
...
/***/ "./src/main/resources/static/js/ToDoItemsList.js":
/*!*******************************************************!*\
  !*** ./src/main/resources/static/js/ToDoItemsList.js ***!
  \*******************************************************/
/*! exports provided: ToDoItemsList */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ToDoItemsList", function() { return ToDoItemsList; });
/* harmony import */ var _ToDoItem__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ToDoItem */ "./src/main/resources/static/js/ToDoItem.js");
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
/*#__PURE__*/
function (_React$Component) {
  _inherits(ToDoItemsList, _React$Component);

  function ToDoItemsList() {
    _classCallCheck(this, ToDoItemsList);

    return _possibleConstructorReturn(this, _getPrototypeOf(ToDoItemsList).apply(this, arguments));
  }

  _createClass(ToDoItemsList, [{
    key: "render",
    value: function render() {
      var tasksList = this.props.taskList.map(function (task) {
        return React.createElement(_ToDoItem__WEBPACK_IMPORTED_MODULE_0__["ToDoItem"], {
          task: task
        });
      });
      return React.createElement("div", {
...
/* harmony import */ var _indexer__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./indexer */ "./src/main/resources/static/js/indexer.js");
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
function (_React$Component) {
  ...
  _createClass(App, [{
    ...
    value: function componentDidMount() {// client({method: 'GET', path: '/api/tasks'}).done(response => {
    ...
    key: "render",
    value: function render() {
      return React.createElement(_indexer__WEBPACK_IMPORTED_MODULE_0__["Index"], {
...
/***/ "./src/main/resources/static/js/indexer.js":
/*!*************************************************!*\
  !*** ./src/main/resources/static/js/indexer.js ***!
  \*************************************************/
...
/* harmony import */ var _todoheader__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./todoheader */ "./src/main/resources/static/js/todoheader.js");
/* harmony import */ var _InputTaker__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./InputTaker */ "./src/main/resources/static/js/InputTaker.js");
/* harmony import */ var _ToDoItemsList__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ToDoItemsList */ "./src/main/resources/static/js/ToDoItemsList.js");
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
function (_React$Component) {
  ...
  _createClass(Index, [{
    key: "render",
    value: function render() {
      return React.createElement("div", null, React.createElement(_todoheader__WEBPACK_IMPORTED_MODULE_0__["TodoHeader"], null), React.createElement(_InputTaker__WEBPACK_IMPORTED_MODULE_1__["InputTaker"], null), React.createElement(_ToDoItemsList__WEBPACK_IMPORTED_MODULE_2__["ToDoItemsList"], {
...
/***/ "./src/main/resources/static/js/todoheader.js":
/*!****************************************************!*\
  !*** ./src/main/resources/static/js/todoheader.js ***!
  \****************************************************/
